...
var aheadItems = []aheadItem{
	...
	{ID: "LID-5", Prio: "P2", Services: []string{"srtm"}, Title: "POST /api/v1/processing/queue low-priority hint (dedupe, instant)",
		Spec: "Body {kgs:[..], priority:\"low\", source:\"siedler\"}. Skips processed KGs, dedupes queued ones, returns ≤1 s with 202 {queued[], skipped[], position}. Hard cap 20 KGs/call, 100/h per source.",
