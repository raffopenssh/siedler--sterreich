...
const I18N_EXACT = {
  ...
  'Äcker reifen alle 40 Minuten — jeder zu seiner Zeit. Ist deiner golden, zeigt ein 🌾-Marker: ernten bringt Münzen. Wartest du zu lang, ernten die Bauern. Oder lass ihn als': 'Fields ripen every 40 minutes — each in its own time. When yours turns golden a 🌾 marker appears: harvesting earns coins. Wait too long and the farmers take it. Or leave it as',
  ...
  'Äcker reifen alle 40 Minuten, jeder zu seiner Zeit. Dein nächster ist in': 'Fields ripen every 40 minutes, each in its own time. Your next one is ripe in',
...
const I18N_RX = [
  ...
  [/^([\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}\u{FE0F}\u2696\u26F0]+ )(Erkunde deine Gemeinde|Naturschützer|Landvermesser|Schatzsucher|Waldmeister|Artenforscher|Baumriese|Erntedank)$/u, function(_,e,t){return e+({'Erkunde deine Gemeinde':'Explore your municipality','Naturschützer':'Conservationist','Landvermesser':'Land surveyor','Schatzsucher':'Treasure hunter','Waldmeister':'Forest master','Artenforscher':'Species researcher','Baumriese':'Tree giant','Erntedank':'Harvest festival'})[t];}],
